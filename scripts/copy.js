...
const buildDirectory = path.resolve(
	'/Users/Mac/Projects/Nodejs/Muevo/MuevoWebApp/build'
);
const serverDirectory = path.resolve(
	'/Users/Mac/Projects/Nodejs/Muevo/MuevoServer/public'
);

const webTemplateDirectory = path.resolve(
	'/Users/Mac/Projects/Nodejs/Muevo/MuevoServer/app/webTemplates'
);
