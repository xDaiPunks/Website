...
class MarketHelp extends PureComponent {
	constructor(props) {
		super(props);

		this.state = {};

		this.componentName = 'MarketHelp';
	...
	subContentItem() {
		...
		// console.log('MarketHelp publicSale', publicSale);
		// console.log('MarketHelp mintscount', mintsCount);
